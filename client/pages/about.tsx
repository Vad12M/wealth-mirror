            ...
            <div
              ...
              <div className="flex flex-col items-start p-[45px]">
                ...
                <Typography
                  ...
                  type={'body2'}
                  className="w-[310px] text-start opacity-60"
                />
              </div>
            </div>
            <div
              style={{ backgroundImage: 'url("/aboutUs/about-2.svg")' }}
              className='w-[322px] md:w-[290px] h-[317px] rounded-[40px]'>
            ...
            <div
              ...
              <div className="flex flex-col items-start pt-[45px] pl-4">
                ...
                <Typography
                  ...
                  type={'body2'}
                  className="w-[270px] text-start opacity-60"
                />
              </div>
            </div>
          </div>
            ...
            <div
              ...
              <div className="flex flex-col items-start pt-[15px] pl-6">
                ...
                <Typography
                  ...
                  type={'body2'}
                  className="w-[260px] text-start opacity-60"
                />
              </div>
            </div>
          </div>
            ...
            <div
              ...
              <div className="flex flex-col items-start pt-[45px] pl-6">
                ...
                <Typography
                  ...
                  type={'body2'}
                  className="w-[484px] text-start opacity-60"
                />
              </div>
            </div>
            <div
              ...
              <div className="flex flex-col items-end pt-[45px] pr-6">
                ...
                <Typography
                  ...
                  type={'body2'}
                  className="w-[428px] text-end opacity-60"
                />
              </div>
            </div>
          </div>
